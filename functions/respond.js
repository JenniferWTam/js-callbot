...
exports.handler = async function(context, event, callback) {
    ...
    function formatConversation(conversation) {
        ...
        const messages = [{
                role: "system",
                content: "You are a friendly, helpful, and concise  AI assistant named Jen's Assistant. Please help the user make reservations at restaurants. You should ask them what restaurant they'd like to make a resrvation at, their party size, time and date preferences.",
            },
            {
                role: "user",
                content: "We are trying to make a reservation at a restaurant",
            },
        ];
